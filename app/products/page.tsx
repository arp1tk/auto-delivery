          ...
          <AnimatePresence mode="popLayout">
            {filteredProducts.map((product) => (
              <motion.div
                ...
                <div className="relative w-full h-72 mb-6 flex items-center justify-center">
                  <div className="absolute w-64 h-64 rounded-full bg-[#EFEFE9] z-0 group-hover:scale-105 transition-transform duration-500 ease-out" />
                  <Image
                    src={product.image}
                    alt={product.name}
                    height={400}
                    width={400}
                    className="relative z-10 max-h-[80%] w-auto object-contain drop-shadow-lg group-hover:-translate-y-2 transition-transform duration-500 ease-out" />
